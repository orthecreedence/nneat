...
double NEAT::mutdiff_coeff = 0.2;
double NEAT::compat_threshold = .04;
...
int NEAT::dropoff_age = 9999;  // Age where Species starts to be penalized 
...
int NEAT::babies_stolen = 2; // The number of babies to siphen off to the champions 
int NEAT::num_runs = 0;
