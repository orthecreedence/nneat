...
double NEAT::age_significance = 1.1; // How much does age matter? 
double NEAT::survival_thresh = 0; // Percent of ave fitness for survival 
double NEAT::mutate_only_prob = .1; // Prob. of a non-mating reproduction 
...
int NEAT::dropoff_age = 4;  // Age where Species starts to be penalized 
...
int NEAT::babies_stolen = 4; // The number of babies to siphen off to the champions 
int NEAT::num_runs = 0;
